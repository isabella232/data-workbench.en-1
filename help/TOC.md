...
+ Dashboard administrator {#admin}
   ...
   + Server Communication {#servers-communication}
...
+ Implement Data Workbench {#implement}
   ...
   + Configuration and Implementation {#implement-configure}
   ...
   + Implementation of Features {#feature-implemenatation}
...
+ [Data Workbench with the Analytics Data Feed](home/assets/dwb-analytics-implementation.pdf)
