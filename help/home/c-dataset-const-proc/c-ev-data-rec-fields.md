...
<table id="table_98E135FE4EAF44D6ADEB3C6C1C0BF6A4">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col2"> <p>The HTTP referrer string sent by the client to the server with the request. </p> <p> Example: <span class="filepath"> https://www.mysite.net/cgi-bin/websearch?qry </span> </p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colname="col2"> <p>The method type of the HTTP request. </p> <p> Example: GET </p> <p> Reference: <span class="filepath"> https://www.w3.org/TR/2000/NOTE-shoplogfileformat-20001115/#field_method </span> </p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colname="col2"> <p>The status code returned to the client by the server. </p> <p> Example: 200 </p> <p> Reference: <span class="filepath"> https://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html </span> </p> </td>
  </tr>
  <tr>
...
<table id="table_3B008F1314804A69AE69E8F94908F497">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col2"> <p>The entire hostname of the referrer. </p> <p> Example: If cs(referrer) is <span class="filepath"> https://my.domain.com/my/page </span>, cs(referrer-host) is <span class="filepath"> my.domain.com </span>. </p> </td>
  </tr>
  <tr>
