...
uuid: 160decf3-b3be-45de-8314-cc885df46cf1
index: y
internal: n
snippet: y
---
...
* Resolved an issue where some times hashed values would show up in merchandising eVars. 
* Internal improvements within the process to continue to deliver better stability and performance.
...
1. Locate the current Decoder Group. Typically, located in the Dataset\Log Processing\Decoding [!DNL Instructions.cfg] found within a Profile Manager. 
1. Within the configuration file, right-click on the current decoder format and select Copy. 
1. Right-click and paste a new entry below the current decoder format. 
1. Expand the new decoder format and add two new field positions to the end of the list. These positions can be left empty if you aren't ready to use the new fields in the dataset, or define them as follows.

    * [!DNL x-mcvisid] 
    * [!DNL x-tnt-action]

## Decoding Instructions {#section-ba63132ce9604851ad319b6181011820}
