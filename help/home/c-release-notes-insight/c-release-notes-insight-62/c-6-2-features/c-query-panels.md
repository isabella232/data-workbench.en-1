...
uuid: b3f285d3-8e66-4183-b227-c26b4ff15790
index: y
internal: n
snippet: y
---
...
<table id="table_3E43DBA0646842898F14F31374F9E39C"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> <p>A list of all dimensions in your query model. </p><img placement="break" align="center" id="image_D7D317D84C0843BE8D324E5B9F7AF20D" src="assets/query_entity_dim_panel.png" /> </td> 
   <td colname="col2"> <p>A list of all metrics in your query model. </p><img placement="break" align="center" id="image_04553B2F2C6A48FE897B4EFF002BED59" src="assets/query_entity_metric_panel.png" /> </td> 
   <td colname="col3"> <p>A list of all filters created for your organization. </p><img placement="break" align="center" id="image_920E72D795644634A82D1955CB64B355" src="assets/query_entity_filters_panel.png" /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_072047E919204577AE85789BAE0F4EE8"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2">In the Dimension tab, you can right-click on the tab heading to sort by the type of dimension. <p><img id="image_FB44D0F4D36B4AD7A6165E0432211AB6" align="center" placement="break" src="assets/query_entity_search_types.png" /> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2">Right-click in the <span class="uicontrol"> Finders</span> bar in the left sidebar to open a menu for additional features. <p style="text-align: center;"><img placement="break" align="center" id="image_4DA4930294B84308A1E627C828C35663" src="assets/finders_menu.png" /> </p> </td> 
  </tr> 
  <tr valign="top"> 
